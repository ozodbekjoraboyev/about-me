...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A Kanban-style project management tool inspired by Trello with real-time updates and collaborative features.",
    image:
      "https://images.pexels.com/photos/5961212/pexels-photo-5961212.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    tags: ["React", "Shadcn/ui", "Redux Toolkit", "TypeScript"],
    demoUrl: "https://example.com/demo3",
    githubUrl: "https://github.com/ozodbekdev/task-management",
  },
  {
    id: 4,
    ...
    tags: ["React", "SCSS", "API Integration"],
    demoUrl: "https://example.com/demo4",
    githubUrl: "https://github.com/ozodbekdev/weather-app",
  },
  {
    id: 5,
